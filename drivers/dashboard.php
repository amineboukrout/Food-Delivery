...
$_SESSION['Driver_UID'] = $uid;

function on_click($rowe, $rRUID, $Ordernumber){
    $_SESSION['address'] = $rowe['Flatnobuldngno'].' '.$rowe['StreetName'].', '.$rowe['Area'].', '.$rowe['City'];
    $_SESSION['rUID'] = $rRUID;
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="viewfoodorder.php?orderid=<?php echo $row['Ordernumber'];?>" onclick="<?php on_click($row,$rUID,$row['Ordernumber']); ?>"><?php echo $row['Ordernumber'];?></a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
