...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <p><span class="primary-color"><strong>Find Your Awesome Restaurant...</strong></span> </div>
            </p>
                            ...
                            <div class="sidebar clearfix m-b-20">
                                ...
                                <div class="main-block">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control search-field" placeholder="Search your favorite Restaurant" name="searchdata" id="searchdata"> <span class="input-group-btn">
